...
print("Leaky Relu Versus Relu for RNN-CNN")
print(len(training))
...
#save model
model_name = "relu_model_20_epochs.pth"
torch.save(net.state_dict(),model_name)

new_name = "train_accuracy_relu_model_20_epochs.pickle"
with open(new_name, 'wb') as f:
    pickle.dump(train_accuracies, f)

new_name = "test_accuracy_relu_model_20_epochs.pickle"
with open(new_name, 'wb') as f:
...
plt.savefig("relu_accuracies_plot.png")
plt.show()
plt.close()
...
filename = "test_accuracy_learning_rate_model_0_20_epochs.pickle"
testing_accuracy_cnn_high = pickle.load( open(filename, "rb") )

# Plots the number of sampled indexes against the estimation
plt.plot(epochs, testing_accuracy_cnn_high, color="purple", linewidth = 2)

plt.plot(epochs, overall_test_accuracies[0], color="blue", linewidth = 2)

plt.xlabel('Number of Epochs')
plt.ylabel('Test Accuracy') 
plt.legend(["Relu", "LeakyRelu"], loc = "upper right")
plt.title('Testing Accuracy with LeakyRelu versus Relu')

plt.savefig('relu_diff_all_models_plot.png')
plt.show()